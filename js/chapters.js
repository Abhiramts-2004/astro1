 ...
 * Handles smooth scrolling and active chapter highlighting for chapter.html
 */
...
class ChapterNavigation {
  ...
  updateActiveChapter() {
    ...
    // Update highlighting only if chapter changed
  ...
  updateIndexHighlight(activeChapterId) {
    ...
    // Update active states in one pass
    ...
    // Auto-scroll index to show active item
